...
public enum EnumForgeVersion {
	...
	v1_14_2("http://export.mcpbot.golde.org/mcp_stable/53-1.14.2/mcp_stable-53-1.14.2.zip", "1.14.4"),
	v1_15("http://export.mcpbot.golde.org/mcp_stable/60-1.15/mcp_stable-60-1.15.zip", "1.15"),
	Snapshot("", "Snapshot"),
	;
	...
	public void setCustom(String snapshotNum, String versionNum) {
		...
		zipLink = "http://export.mcpbot.golde.org/mcp_snapshot/" + snapshotNum + "-" + versionNum + "/mcp_snapshot-" + snapshotNum + "-" + versionNum + ".zip";
	}
